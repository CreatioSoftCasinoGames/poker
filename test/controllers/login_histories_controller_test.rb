...
class LoginHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create login_history" do
    assert_difference('LoginHistory.count') do
      post :create, login_history: { active: @login_history.active, login_token: @login_history.login_token, user_id: @login_history.user_id }
    end
  ...
  test "should update login_history" do
    patch :update, id: @login_history, login_history: { active: @login_history.active, login_token: @login_history.login_token, user_id: @login_history.user_id }
    assert_redirected_to login_history_path(assigns(:login_history))
  end
