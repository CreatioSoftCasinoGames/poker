class Api::V1::UsersController < Api::V1::ApplicationController
	...
	def user_params
		params.require(:user).permit(:first_name, :last_name, :password, :password_confirmation, :image, :fb_id, :email, :device_avatar_id, friend_requests_attributes: [:requested_to, :status])
	end
